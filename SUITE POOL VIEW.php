...
<div class="carousel-inner">
     <div class="carousel-item active">
	      <img class ="Image" src="images/img/sp-1.jpg" alt="ALLISON HOTEL">
	
	 </div>
	 <div class="carousel-item">
	      <img class ="Image1" src="images/img/sp-2.jpg">
...
<div class ="container">
		...
		<h1 class ="z1"style="text-align:center">SUITE POOL VIEW</h1>
		<h6 style ="text-align:center">_______</h6>
		<h5 class ="mt-4 col-md-9 col-xl-12 col-sm-4">An ultra-spacious, elegantly designed suite featuring a separate bedroom, lounge for extra privacy,and bathroom with bathtub and rain shower. A major highlight of this luxurious suite comes with animpressive private heated pool located in its own spacious private garden.</h5>
...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="img_silde" src="images/img/121.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="img_silde" src="images/img/122.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="img_silde" src="images/img/123.jpg" alt="Third slide">
    </div>
  </div>
		...
		<div class ="col-md-7">
			<div class="card mb-3" style="max-width: 680px;">
				<div class="row no-gutters">
					<div class="col-md-6">
						<img src="images/img/124.jpg" class="card-img" alt="..." style="height:100%">
					</div>
					<div class="col-md-6">
						<div class="card-body">
							<h5 class="card-title">Breakfast and more on us</h5>
								...
								<h6 class="card-text">Price
									<p class="text" style ="font-size:25px;"><strong>USD 392.78/night</strong></p>
								</h6>
...
<div class ="container">
	<div class ="row mt-5 ">
		<div class ="col-md-12">
			<div class="card mb-3">
				<img class="card-img-top" src="images/img/118.jpg" alt="Card image cap">
				<div class="card-body" style ="">
					<h3 class="card-title mt-3"style ="text-align:center;">UPGRADE TO TWIN POOL VIEW FROM<br> FROM JUST €77 EXTRA PER NIGHT</h3>
					<button type="button" class="btn btn-dark btn-lg offset-md-5 mt-2"><a href ="TWIN POOL VIEW.php"style="text-decoration:none;">UPGRADE NOW</a></button>
				</div>
			</div>
		</div>
	</div>
