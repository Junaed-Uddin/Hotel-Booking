...
<div class="carousel-inner">
     <div class="carousel-item active">
	      <img class ="Image" src="images/img/dd-1.jpg" alt="ALLISON HOTEL">
		
	 </div>
	 <div class="carousel-item">
	      <img class ="Image1" src="images/img/dd-2.jpg">
...
<div class ="container">
		...
		<h1 class ="z1"style="text-align:center">DELUXE DOUBLE ROOM</h1>
		<h6 style ="text-align:center">_______</h6>
		<h5 class ="mt-4 col-md-9 col-xl-12 col-sm-4">Contemporary designed, stylish double room located in main building. All come with floor to ceiling windows, offering impressive sea or inland views.</h5>
...
<div class ="container mt-5">
	<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="img_silde" src="images/img/2.jpg" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="img_silde" src="images/img/108.1.jpg" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="img_silde" src="images/img/bed1.jpg" alt="Third slide">
			</div>
		</div>
			...
			<div class="card" style="width: 28.5rem;">
				<div class="card-header bg-dark"style ="color:#ffffff "><h5 style ="font-family:Times New Roman">Amenities</h5></div>
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">Nespresso machine</li>
						...
						<div class="card-body">
							<h5 class="card-title">Breakfast and more on us</h5>
								...
								<h6 class="card-text">Price
									<p class="text" style ="font-size:25px;"><strong>USD 192.78/night</strong></p>
								</h6>
...
<div class ="container">
	<div class ="row mt-5">
		<div class ="col-md-12">
			<div class="card mb-3">
				<img class="card-img-top" src="images/img/114.jpg" alt="Card image cap">
				<div class="card-body" style ="">
					<h3 class="card-title mt-3"style ="text-align:center;">UPGRADE TO DELUXE TRIPPLE ROOM FROM <br> JUST €16 EXTRA PER NIGHT</h3>
					<button type="button" class="btn btn-dark btn-lg offset-md-5 mt-2"><a href ="DELUXE TRIPPLE ROOM.php"style="text-decoration:none;">UPGRADE NOW</a></button>	
				</div>
			</div>
		</div>
	</div>
