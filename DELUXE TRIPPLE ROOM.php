...
<html lang="en">
<head>
	<title>DELUXE TRIPPLE ROOM</title>
	<meta charset="utf-8">
...
<div class="carousel-inner">
     <div class="carousel-item active">
	      <img class ="Image" src="images/img/ddd-1.jpg" alt="ALLISON HOTEL">
	 </div>
	 <div class="carousel-item">
	      <img class ="Image1" src="images/img/ddd-2.jpg">
...
<div class ="container">
		...
		<h1 class ="z1"style="text-align:center">DELUXE TRIPPLE ROOM</h1>
		<h6 style ="text-align:center">_______</h6>
		<h5 class ="mt-4 col-md-9 col-xl-12 col-sm-4">Contemporary designed stylish double room in main building with spacious seating area offering comfortable space for two adults and one child. Each room has a private furnished balcony with impressive sea or inland view and en-suite bathroom with rain shower.</h5>
...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="img_silde" src="images/img/6.1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="img_silde" src="images/img/113.1.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="img_silde" src="images/img/120.jpg" alt="Third slide">
    </div>
  </div>
		...
		<div class ="col-md-7">
			<div class="card mb-3" style="max-width: 680px;">
				<div class="row no-gutters">
					<div class="col-md-6">
						<img src="images/img/10_10.jpg" class="card-img" alt="..." style="height:100%">
					</div>
					<div class="col-md-6">
						<div class="card-body">
							<h5 class="card-title">Breakfast and more on us</h5>
								...
								<h6 class="card-text">Price
									<p class="text" style ="font-size:25px;"><strong>USD 292.78/night</strong></p>
								</h6>
...
<div class ="container">
	<div class ="row mt-5">
		<div class ="col-md-12">
			<div class="card mb-3">
				<img class="card-img-top" src="images/img/116.jpg" alt="Card image cap">
				<div class="card-body" style ="">
					<h3 class="card-title mt-3"style ="text-align:center;">UPGRADE TO SUITE POOL VIEW FROM<br> JUST €34 EXTRA PER NIGHT</h3>
					<button type="button" class="btn btn-dark btn-lg offset-md-5 mt-2"><a href ="SUITE POOL VIEW.php"style="text-decoration:none;">UPGRADE NOW</a></button>
				</div>
			</div>
		</div>
	</div>
